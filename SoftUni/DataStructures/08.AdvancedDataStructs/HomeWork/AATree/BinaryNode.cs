namespace AATree
{
    ...
    public class BinaryNode<TValue> where TValue : IComparable<TValue>
    {
        ...
        private void PrintNode(String prefix, bool isTail, BinaryNode<TValue>[] children)
        {
            ...
            {
                Console.WriteLine(defaultSpace + this.Value);
            }
            else
            {
                Console.WriteLine(prefix + (isTail ? tailEnding : midEnding) + this.Value);
            }
            ...
            foreach (var child in children)
            {
                ...
                child.PrintNode(prefix + (isTail ? defaultSpace : childSpace), tailCheck, children);
                i++;
            }
        }
#endif
