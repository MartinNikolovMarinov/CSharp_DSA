namespace AATree
{
    ...
    public class AATree<TValue> : ICollection<TValue> where TValue : IComparable<TValue>
    {
        ...
        protected static BinaryNode<TValue> Skew(BinaryNode<TValue> node)
        {
            if (node == null)
            {
                return null;
        ...
        protected static BinaryNode<TValue> Split(BinaryNode<TValue> node)
        {
            if (node == null)
            {
                return null;
        ...
        protected static BinaryNode<TValue> DecreeseLevel(BinaryNode<TValue> node)
        {
